...
|----------------|-----------------------------------------------|--------------------------------------------------------------|
| `DATABASE_URL` | Postgres connection string used by `pg`       | `postgresql://thuzar:thuzar_pass@localhost:5432/csv_cleaner` |
...
```json
{ "jobId": 2, "status": "failed", "fileName": "1718999999999_bad.csv", "errorMessage": "validation failed: [...]" }
```
